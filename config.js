...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~6FEDkIiA#7TqKs7kwBKyMpnUGHo9wDePr2aV_3DABFBGM6FkyQwc",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE RAMADARK WHATSAPP BOT ♻️ FUCK YOU",
    ...
    BOT_NAME: process.env.BOT_NAME || "➺RAMADARK_BOT",
